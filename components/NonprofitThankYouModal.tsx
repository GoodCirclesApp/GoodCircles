...
const NONPROFIT_MESSAGES: Record<string, { director: string; title: string; messages: Record<number, { message: string; equivalent: string }> }> = {
  default: {
    ...
    messages: {
      ...
      100: { message: 'One hundred dollars generated through everyday shopping. This is what Good Circles was built for — and you\'re living proof it works. Thank you.', equivalent: 'A month of community programming' },
