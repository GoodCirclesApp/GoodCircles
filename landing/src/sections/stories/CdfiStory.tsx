      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div {...fadeUp(0.05)} className="mb-14">
          ...
          <p className="text-lg text-slate-600 mb-10 leading-relaxed" style={{ fontFamily: "'Fira Sans', sans-serif" }}>
            GoodCircles gives Treasury-certified CDFIs a live window into merchant performance —
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: <Building2 size={20} />, title: 'Pre-engaged relationships',     body: 'Merchants on GoodCircles are already community-invested. No cold outreach required.' },
            ].map((card, i) => (
