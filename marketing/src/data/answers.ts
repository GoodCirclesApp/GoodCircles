...
export const ANSWERS: Answer[] = [
  ...
  },
  {
    ...
    bodyHtml:
      ...
      `<p>Good Circles charges a <b>1% fee on profit</b>, so you keep about <b>89% of your profit</b>. It also collects and remits sales tax for you as the marketplace facilitator, and it brings customers a reason to choose you: they save about 10% and fund a local nonprofit when they buy from you. See the full breakdown on <a href="/for-business/">Good Circles for business</a>, compare every major marketplace in the <a href="/sell/marketplace-fees-comparison/">seller-fee comparison</a>, and learn <a href="/how-it-works/">how it works</a>.</p>` +
  ...
  },
  {
    ...
    bodyHtml:
      ...
      `<h2>Is a community marketplace the same as a "local commerce platform"?</h2>` +
      `<p>Essentially, yes — <b>a local commerce platform is the infrastructure; a community marketplace is what it becomes when the economics favor the community.</b> Any software that lets local businesses list, sell, and get paid is a local commerce platform. It earns the name "community marketplace" when the transaction itself is structured for local benefit: on Good Circles that means the shopper's ~10% saving, the business keeping 89% of profit on a 1% fee, and 10% of profit funding a shopper-elected nonprofit. For how that compares with the big platforms' 15–30%-of-sale fees, see <a href="/compare/good-circles-vs-national-marketplaces/">Good Circles vs national marketplaces</a>.</p>` +
      `<h2>Is there a community marketplace app?</h2>` +
      `<p><b>Good Circles is web-first — there's no app to download.</b> You sign up and shop from any phone or computer at goodcircles.org, which keeps it accessible to every neighbor and every business without an app-store step. Mobile apps are on the roadmap after launch; joining now happens on the web in about two minutes, and in Meridian &amp; Lauderdale County <a href="/meridian/">early access is already underway</a>.</p>` +
