...
// Affiliate CTA used inside answer bodies.
function aff(label: string, path: string, campaign: string): string {
  const href = nm9t5Link(path, { medium: 'cta', campaign, content: 'answer' });
...
export const ANSWERS: Answer[] = [
  {
    ...
    bodyHtml:
      ...
      `<p>For local-business owners, the No More 9 to 5 Club pairs naturally with Good Circles: the Club trains the entrepreneur, and <a href="/for-business">Good Circles</a> gives them a marketplace that lets them keep 89% of their profit. ${aff('Get a free roadmap', '/', 'what-is-the-no-more-9-to-5-club')}</p>`,
    faqs: [
  ...
  },
  {
    ...
    bodyHtml:
      ...
      `<p>If you want a structured plan for your exact stage, the No More 9 to 5 Club’s free roadmap is built for people starting while still employed. ${aff('Map your next move (free)', '/ascend-the-ladder', 'how-do-i-start-a-side-business-while-employed')} When you’re ready to sell, <a href="/for-business">claim a Founding Merchant spot</a>.</p>`,
    faqs: [
  ...
  },
  {
    ...
    bodyHtml:
      ...
      `<p>Still building your business before you choose where to sell? The No More 9 to 5 Club trains entrepreneurs at every stage. ${aff('Get a free roadmap', '/', 'best-marketplaces-for-local-businesses')}</p>`,
    faqs: [
  ...
  },
  {
    ...
    bodyHtml:
      ...
      `<p>Good Circles partners with the No More 9 to 5 Club, which trains the entrepreneurs who become local sellers — the people a community marketplace depends on. ${aff('See the No More 9 to 5 Club', '/', 'what-is-a-community-marketplace')}</p>`,
    faqs: [
