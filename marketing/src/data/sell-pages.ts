...
export const SELL_PAGES: SellPage[] = [
  {
    ...
    faqs: [
      { q: "How much does Good Circles cost compared to Uber Eats?", a: "Uber Eats charges 20-30% of each Marketplace order by plan (Lite 20% / Plus 25% / Premium 30%). Good Circles charges a 1% fee on profit - no per-order commission, no ad spend, no merchant card cost, and no monthly or listing fees. If you don't sell, you don't pay." },
