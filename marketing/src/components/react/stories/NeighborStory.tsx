      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div {...fadeUp(0.05)} className="mb-14">
          ...
          <p className="text-lg text-slate-600 mb-10 leading-relaxed" style={{ fontFamily: "'Fira Sans', sans-serif" }}>
            Every local purchase you make through Good Circles is about 10% cheaper than the sticker price.
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              { icon: <Leaf size={22} />,         title: 'Zero extra effort', body: 'Pick your nonprofit once at signup. Good Circles handles everything else. You just shop.' },
            ].map((card, i) => (
              <motion.div
                key={i}
                {...fadeUp(0.1 + i * 0.08)}
        ...
        <motion.div {...fadeUp(0.4)}>
          <div className="p-8 rounded-3xl" style={{ background: '#fff', boxShadow: `0 4px 40px ${COLOR}12` }}>
            ...
            <p className="text-slate-500 mb-8" style={{ fontFamily: "'Fira Sans', sans-serif" }}>
              Founding members get first access when Good Circles launches September 2026. Spots are limited.
            </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <input
                type="text"
                aria-label="ZIP code (optional — helps us match local merchants)" placeholder="ZIP code (optional — helps us match local merchants)"
                value={zip}
