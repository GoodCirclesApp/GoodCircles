...
const SHARE_COPY: Record<string, string> = {
  NEIGHBOR:  "I just claimed my founding spot in Good Circles — the community marketplace launching September 2026. Every local purchase saves you about 10% and automatically funds the nonprofit you love. Forever. No extra steps. Founding spots are limited:",
  MERCHANT:  "I just claimed my Founding Merchant spot on Good Circles. Unlike every other platform: keep 89% of net profit, zero algorithm tax on your visibility, and your customers save about 10% on every local purchase. This is what local business has been waiting for:",
  NONPROFIT: "I just claimed our nonprofit's founding spot on Good Circles — a marketplace that routes 10% of merchant profit to nonprofits automatically, on every transaction, forever. No fundraising. No grants. Just recurring revenue that grows with the community:",
  CDFI:      "Just requested a founding partnership briefing with Good Circles — a community marketplace launching September 2026 with live merchant performance data, QIA targeting, and TLR-ready packages built for CDFI underwriting:",
  MUNICIPAL: "Just requested a founding partnership briefing with Good Circles — a community marketplace launching September 2026 that tracks local spend retention and surfaces small business growth in real time. No new programs. Just the data your community needs:",
};
...
I just claimed my founding spot in Good Circles and you were one of the first people I thought to tell.

It's a community marketplace launching September 2026. The short version: you shop local, automatically save about 10% on every local purchase, and 10% of the merchant's profit flows to the nonprofit of your choice — every transaction, forever, with zero extra effort.
...
I just claimed my Founding Merchant spot on Good Circles and thought of your business immediately.

Here's what makes it different from every other platform: you keep 89% of your net profit (compare that to Amazon's ~70% or Etsy's ~80%), your customers save about 10% automatically which drives real loyalty, and 10% of your profit goes to local nonprofits as a tax-deductible contribution.
...
I just claimed a founding spot in Good Circles and your organization was the first thing I thought of.

Good Circles is a community marketplace launching September 2026. The model: when neighbors shop local through Good Circles, 10% of every merchant's net profit flows directly to the nonprofit their customers have elected — automatically, on every transaction, forever.
...
export default function Confirmation({ data }: Props) {
  ...
  const Logo = () => (
    <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex justify-center mb-10">
      <img src="/logos/logo-white-md.png" alt="Good Circles" style={{ height: 48, width: 'auto' }} />
    </motion.div>
  );
      ...
      <div className="relative z-10 max-w-lg w-full text-center">
        ...
        >
          ...
          <p className="text-white/45 text-xs text-center mb-6 leading-relaxed" style={{ fontFamily: "'Fira Sans', sans-serif" }}>
            A personal message converts better than any post. Edit it, make it yours, and send. The more of your community joins before launch, the more Good Circles is worth to you on day one — more merchants to shop, more neighbors to shop with.
          </p>
