  ...
  return (
    <div id="print-report" style={{ fontFamily: 'Georgia, serif', maxWidth: 800, margin: '0 auto', padding: 40, color: '#111' }}>
      <div style={{ borderBottom: '3px solid #7851A9', paddingBottom: 16, marginBottom: 24 }}>
        <div style={{ fontSize: 10, color: '#666', textTransform: 'uppercase', letterSpacing: 2 }}>Good Circles Community Impact Report</div>
      ...
      <div style={{ marginTop: 32, pageBreakBefore: 'always' }}>
        ...
        <p style={{ fontSize: 12, lineHeight: 1.7, marginBottom: 16, color: '#333' }}>
          ...
          Good Circles facilitates economic transactions within geographically-defined LMI areas as determined by
        ...
        <p style={{ fontSize: 12, lineHeight: 1.7, marginBottom: 16, color: '#333' }}>
          During this reporting period, Good Circles facilitated <strong>{fmtN(data.txCount)}</strong> economic
        ...
        <div style={{ marginTop: 24, borderTop: '1px solid #ddd', paddingTop: 16, fontSize: 10, color: '#888' }}>
          This report was generated by Good Circles Impact Transparency System. Data reflects platform transactions
          processed through the Good Circles marketplace. For IDIS entry assistance contact your HUD CPD representative.
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className={`rounded-2xl p-4 text-xs ${
            ...
            {demoMode
              ? 'Demo data uses deterministic simulation scaled to real population distributions. Toggle to Live Mode to see real Good Circles transaction data.'
              : 'Showing live Good Circles transaction data. Demo overlay available for presentation purposes.'}
          </div>
        </div>
      </div>
